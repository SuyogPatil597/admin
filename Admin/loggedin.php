...
<body>
    ...
    <br>
    <!-- <input type="button" style="margin-left: 1200px;"  value="PRINT" onclick="printDiv()"> -->
    <button type="button" class="btn btn-primary" style="margin-left: 1200px;" value="PRINT" onclick="printDiv()">PRINT</button>
    <div class="container" id="g">
         <h1>Registered Users :</h1>  


        <table border="1px" class="table  mt-3" style="border-collapse:collapse;">
  <thead>
    <tr>
